    ...
    <table class="table2">
      <tr>
        <td colspan="100" style="width: 100%;">
          ...
          <table class="table2">
            <tr>
              <td colspan="20" class="info_empleado" style="20%;padding: 0px 10px 0px 0px"><strong>COD. ORDEN:</strong> <br> {{ $data_orden['numero_orden'] }}</td>
              <td colspan="30" class="info_empleado" style="30%;border-left: 1px solid #000;padding: 0px 10px 0px 0px"><strong>NOMBRE:</strong> <br> {{ $data_orden['cliente'] }}</td>
              <td colspan="20" class="info_empleado" style="20%;border-left: 1px solid #000;padding: 0px 10px 0px 0px"><strong>EDAD:</strong> <br> {{ $data_orden['edad'] }}</td>
              <td colspan="30" class="info_empleado" style="30%;border-left: 1px solid #000;padding: 0px"><strong>GÉNERO:</strong> <br> {{ strtoupper($data_orden['genero']) }}</p></td>
              </tr>
          </table>
        </div>
        </td>
