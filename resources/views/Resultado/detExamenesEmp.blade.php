...
@section('title', 'Resultados examenes - Clinica empresarial')
...
<nav>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a class="btn btn-outline-info btn-sm" href="{{ route('resultado.eval.atencion') }}" style="font-size: 12px"><i class="bi bi-arrow-left-circle"></i> REGRESAR</a></a></li>
        <li class="breadcrumb-item"><i class="bi bi-journal-plus"></i> <span id="title_content_page"></span></li>
        <li class="breadcrumb-item active"><i class="bi bi-person-check"></i> COLABORADOR A EVALUAR: <span id="display_nombre_empleado"></span></li>
    </ol>
</nav>
@endsection
...
@push('js')
<script src="{{ versioned_asset('assets/js/resultados/detResultExamenes.js') }}"></script>
<script src="{{ versioned_asset('assets/js/resultados/examen_resultado_img.js') }}"></script>
<script src="{{ versioned_asset('assets/js/resultados/image_upload.js') }}"></script>
<script src="{{ versioned_asset('assets/js/resultados/fullscreenImage.js') }}"></script>
@endpush