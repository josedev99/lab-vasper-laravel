...
<h1 class="fs-5">Registro médico / preparación</h1>
<nav>
    <ol class="breadcrumb">
...
@include('RegistroMedico.modal.preparacion_consulta')
                ...
                <div class="row">
                    <div class="col-sm-8 d-flex justify-content-start align-items-center">                        
                        <div class="radio icheck-turquoise d-inline">
                            <input type="radio" id="citas" name="opcionCitaColab" value="citas">
                            <label for="citas">Citas</label>
                        </div>
                        <div class="radio icheck-turquoise d-inline mx-3">
                            <input type="radio" id="colaboradores" name="opcionCitaColab" value="colaboradores">
                            <label for="colaboradores">Colaboradores</label>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 d-flex justify-content-center align-items-center" id="component-date-filter">
...
<script src="{{ versioned_asset('assets/js/registro/preparacion_consulta.js') }}"></script>
