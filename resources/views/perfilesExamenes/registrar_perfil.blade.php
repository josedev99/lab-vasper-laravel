...
<div class="modal fade" id="modal_nuevo_perfil" data-bs-backdrop="static" data-bs-focus="false" data-bs-keyboard="false"
    tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header py-1 px-2 bg-dark text-light">
                <h1 class="modal-title fs-7">REGISTRAR NUEVO PERFIL DE EXAMENES</h1>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body p-1">
                <div class="card p-1 mb-0">
                    <form id="form_examen_perfil">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="card-body p-1" style="box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.1);">
                                    <table id="dt_cat_examenes" width="100%" data-order='[[ 0, "desc" ]]'
                                ...
                                <div class="card-body p-1" style="box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.1);">
                                    <div class="col-sm-12 col-md-12 mb-2">
                                        <div class="content-input mb-2">
                                            <input name="nombre_perfil" type="text" class="custom-input material"
