<div class="modal fade" id="modal_citas" data-bs-backdrop="static" data-bs-focus="false" data-bs-keyboard="false"
    tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header py-1 px-2 bg-dark text-light">
                <h1 class="modal-title fs-7">CITAS</h1>
            ...
            <div class="modal-body p-1">
                <div class="card m-0 p-1">
                    <div class="card-header p-1 d-flex justify-content-end">
                        <button class="btn btn-outline-danger btn-sm" id="btn_views_pdf" title="Descargar PDF de citados.">PDF <i class="bi bi-file-earmark-pdf"></i></button>
                    </div>
                    <div class="card-body p-1">
                        <table id="dt_citados_agenda" width="100%" data-order='[[ 0, "desc" ]]'
